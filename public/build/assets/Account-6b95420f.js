import { as as ExclamationTriangleIcon, r as resolveComponent, o as openBlock, l as createElementBlock, i as createBaseVNode, V as renderSlot, k as createCommentVNode, j as createVNode, t as toDisplayString, g as createBlock, at as ShieldExclamationIcon, m as mapGetters, e as mapActions, n as normalizeClass, q as createTextVNode, af as PowerIcon, ag as mapState, L as axios, f as resolveDirective, ad as Fragment, ae as renderList, p as withDirectives, au as CircleStackIcon, U as UserCircleIcon, z as pushScopeId, E as popScopeId } from "./vendor-b24fd275.js";
import { t as track, _ as _export_sfc, a as parseDisplayDate, c as capitalizeFirstLetter, p as providerIcon } from "./app-7a34098f.js";
...
const _hoisted_6$1 = { class: "bg-white px-4 pt-5 pb-4 dark:bg-slate-900 sm:p-6 sm:pb-4" };
const _hoisted_7$1 = {
  key: 0,
...
const _hoisted_10$1 = { class: "mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left" };
const _hoisted_11$1 = {
  id: "modal-title",
...
function _sfc_render$5(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createVNode(_component_ShieldExclamationIcon, { class: "ml-auto mr-auto mt-6 mb-5 h-14 w-14 text-red-500" }),
    _hoisted_1$3,
    _hoisted_2$3,
    createBaseVNode("div", {
...
const _sfc_main$4 = {
  ...
  methods: {
    ...
    triggerRevoke(provider) {
      ...
      "".concat(self.capitalizeFirstLetter(provider.provider), "?</strong>");
      const html = "Are you sure you want to <strong>Revoke</strong><br>".concat(self.capitalizeFirstLetter(
        provider.provider
      ), ' Authentication?<br><br><small><span class="far fa-clock fa-fw fa-xs mr-1"></span>First Used: ').concat(self.parseDisplayDate(
        provider.created_at
      ), '</small><br><small><span class="far fa-clock fa-fw fa-xs mr-1"></span>Last Used: ').concat(self.parseDisplayDate(
        provider.updated_at
      ), "</small>");
      const icon = "warning";
    ...
    async triggerConnect(provider) {
      this.track(
        "Social Login Provider Clicked: ".concat(provider),
        "clicked",
        "user-account"
      );
      this.loading = true;
      try {
        ...
        this.track(
          "Social Provider Failed to Authorize: ".concat(provider),
          "error",
          "auth-error"
        );
        this.popToast({
...
const _hoisted_5$1 = { class: "flex flex-col items-center pt-4 pb-4 pl-2 pr-2" };
...
const _hoisted_14 = { class: "flex flex-col items-center pt-4 pb-4 pl-2 pr-2" };
const _hoisted_15 = { class: "mb-2 text-lg font-extrabold capitalize text-gray-900 dark:text-white" };
const _hoisted_16 = { class: "mt-4 mb-5 flex space-x-3 md:mt-5" };
...
const _sfc_main$3 = {
  ...
  methods: {
    ...
    async triggerUserDataDownload() {
      this.loading = true;
      try {
        const response = await axios.post("/api/user/".concat(this.user.id, "/data"));
    ...
    userDataDownloadConfirmed() {
      this.$swal.fire({
        title: "Success!",
        icon: "success",
        html: "Your data will be ready for download shortly. <br>A download link has been sent to your email <br>".concat(this.user.email),
        showCancelButton: false,
...
const _hoisted_2$1 = { class: "mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:flex lg:items-center lg:justify-between lg:py-16 lg:px-8" };
...
const _sfc_main = {
  ...
  methods: {
    ...
    changeTab(tab) {
      this.activeTab = tab;
      this.track("clicked tab: ".concat(tab));
    }
  }
};
...
//# sourceMappingURL=Account-6b95420f.js.map
