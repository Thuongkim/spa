import { U as UserCircleIcon, e as mapActions, h as hooks, L as axios, r as resolveComponent, g as createBlock, w as withCtx, o as openBlock, q as createTextVNode, t as toDisplayString, k as createCommentVNode, i as createBaseVNode, p as withDirectives, am as vModelText, n as normalizeClass, j as createVNode, l as createElementBlock, s as withModifiers, z as pushScopeId, E as popScopeId, az as ChevronRightIcon, aA as LockClosedIcon, aB as LockOpenIcon, aC as PencilSquareIcon, aD as TrashIcon, m as mapGetters, f as resolveDirective } from "./vendor-b24fd275.js";
import { A as AppModal, s as script, c as clonedeep, a as PerPage, P as Pagination } from "./default.css_vue_type_style_index_0_src_true_lang-9b5ba1ec.js";
...
const _sfc_main$1 = {
  ...
  methods: {
    ...
    async updatePermission() {
      ...
      await axios.patch(
        "/api/permissions/update-permission/".concat(self.permission.id),
        self.form
      ).then(({ data }) => {
        self.$emit("permissionUpdated", data.permission);
        self.popToast({
          message: "Permission ".concat(data.permission.name, " Successfully Updated!"),
          timer: 5e3,
          icon: "success"
        });
...
const _sfc_main = {
  ...
  methods: {
    ...
    async getPermissions(updatedPage = null) {
      ...
      await axios.get(
        "/api/permissions-paginated?page=".concat(this.pagination.current_page, "&per=").concat(this.perPage)
      ).then(({ data }) => {
    ...
    triggerDeletePermission(row) {
      ...
      "".concat(row.name, "</strong>?<h6>This will delete the Permission.</h6>");
      const icon = "warning";
    ...
    async deletePermission(value) {
      await axios.delete("/api/permissions/delete/permission/".concat(value.id)).then(({ data }) => {
    ...
    async update(key, row) {
      ...
      await axios.patch("/api/permissions/update-permission/".concat(row.id), row).then(({ data }) => {
...
//# sourceMappingURL=Permissions-cfc74bd8.js.map
