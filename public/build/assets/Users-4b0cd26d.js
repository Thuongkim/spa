import { aA as LockClosedIcon, aB as LockOpenIcon, aC as PencilSquareIcon, aD as TrashIcon, U as UserCircleIcon, e as mapActions, h as hooks, r as resolveComponent, f as resolveDirective, l as createElementBlock, i as createBaseVNode, t as toDisplayString, ad as Fragment, ae as renderList, k as createCommentVNode, n as normalizeClass, g as createBlock, w as withCtx, j as createVNode, p as withDirectives, o as openBlock, m as mapGetters, L as axios, q as createTextVNode, am as vModelText, s as withModifiers, z as pushScopeId, E as popScopeId, az as ChevronRightIcon, aE as UserPlusIcon } from "./vendor-b24fd275.js";
import { C as CircleSvg, _ as _export_sfc } from "./app-7a34098f.js";
import { P as Pagination, A as AppModal, s as script, c as clonedeep, a as PerPage } from "./default.css_vue_type_style_index_0_src_true_lang-9b5ba1ec.js";
...
const _sfc_main$3 = {
  ...
  methods: {
    ...
    fireVerification() {
      ...
      let title = "<strong>Verify ".concat(this.user.name, "?</strong>");
      let html = "Are you sure you want to <strong>Verify";
      "".concat(this.user.name, "</strong>?<small> (").concat(this.user.email, ")</small>");
      let icon = "warning";
      ...
      if (verified) {
        title = "<strong>Un-Verify ".concat(this.user.name, "?</strong>");
    ...
    triggerDeleteUser() {
      const self = this;
      const title = "<strong>Delete ".concat(this.user.name, "?</strong>");
      const html = "Are you sure you want to <strong>Delete";
      "".concat(this.user.name, "</strong>?<small> (").concat(this.user.email, ")</small><h6>This will delete the user.</h6>");
      const icon = "warning";
    ...
    triggerUserConfirmEmail() {
      const self = this;
      const title = "<strong>Send ".concat(this.user.name, " verification email</strong>");
      const html = "Are you sure you want to <strong>Send ";
      "".concat(this.user.name, "<small> (").concat(this.user.email, ")</small> a Verification Email</strong>?<h6>This will send the user an email.</h6>");
      const icon = "info";
...
const _sfc_main$1 = {
  ...
  methods: {
    ...
    async updateUser() {
      await axios.patch("/api/users/update-user/".concat(this.user.id), this.form).then(({ data }) => {
        this.$emit("userUpdated", data.user);
        this.popToast({
          message: "User ".concat(data.user.name, " Successfully Updated!"),
          timer: 5e3,
          icon: "success"
        });
        this.submitting = false;
...
const UserFormModal_vue_vue_type_style_index_1_scoped_a1f3b03d_lang = "";
const _withScopeId$1 = (n) => (pushScopeId("data-v-a1f3b03d"), n = n(), popScopeId(), n);
...
const UserFormModal = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1], ["__scopeId", "data-v-a1f3b03d"]]);
const _sfc_main = {
  name: "Users",
  components: {
    ChevronRightIcon,
  ...
  methods: {
    ...
    async getUsers(updatedPage = null) {
      ...
      await axios.get(
        "/api/users?page=".concat(this.pagination.current_page, "&per=").concat(this.perPage)
      ).then(({ data }) => {
    ...
    async deleteUser(value) {
      await axios.delete("/api/users/delete/user/".concat(value.id)).then(({ data }) => {
...
//# sourceMappingURL=Users-4b0cd26d.js.map
