import { r as resolveComponent, l as createElementBlock, i as createBaseVNode, n as normalizeClass, j as createVNode, k as createCommentVNode, t as toDisplayString, o as openBlock, aJ as withKeys, az as ChevronRightIcon, m as mapGetters, e as mapActions, L as axios, a6 as toasty, f as resolveDirective, g as createBlock, w as withCtx, ad as Fragment, ae as renderList, q as createTextVNode, p as withDirectives } from "./vendor-b24fd275.js";
import { _ as _export_sfc, t as track } from "./app-7a34098f.js";
import { z as zohoLight, a as zohoDark } from "./zoho-monocrome-black-46b06f59.js";
  ...
  methods: {
    ...
    async updateSetting(newValue, setting) {
      ...
      if (newValue != a.val) {
        ...
        await axios.patch("/api/app-settings/".concat(setting.id), setting).then(({ data }) => {
          ...
          this.track(
            'App setting "'.concat(setting.name, '" was updated from "').concat(a.val, '" to "').concat(setting.val, '"'),
            "app event",
            "app setting updated"
          );
        }).catch(({ response }) => {
...
//# sourceMappingURL=AppSettings-d0fa81ea.js.map
